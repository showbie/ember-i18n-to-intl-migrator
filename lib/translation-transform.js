...
module.exports = function(type = 'json') {
  let locales = fs.readdirSync(path.join('lib', 'showbie-l10n', 'locales'));
  locales.forEach((localeName) => {
    let content = fs.readFileSync(path.join('lib', 'showbie-l10n', 'locales', localeName, 'translations.json'), 'utf8');
